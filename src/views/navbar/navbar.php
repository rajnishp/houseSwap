<header class="navbar navbar-fixed-top" role="banner" style="border-bottom-style: solid; border-bottom-width: 1px; padding-top: 0px;">

    <div class="container">

      <div class="navbar-header">
        <a href="#" class="navbar-brand-img">
          <img src="../../static/img/logo.resized.png" alt="HOUSESWAP">
        </a>
