...
<head>
  ...
  <!-- for Google -->
    ...
    <meta name="url" content="http://www.houseswap.in/house/<?= $house->getId() ?>" />
  ...
  <meta property="og:url"    content="http://www.houseswap.in/house/<?= $house->getId() ?>" /> 
  ...
  <!-- for Twitter -->          
    ...
    <meta name="twitter:url" content="http://houseswap.in/house/<?= $house->getId() ?>" />
